...
function solveFizzBuzz(n: number): string[] { const r: string[] = []; for (let i = 1; i <= n; i++) { if (i % 15 === 0) r.push('FizzBuzz'); else if (i % 3 === 0) r.push('Fizz'); else if (i % 5 === 0) r.push('Buzz'); else r.push(String(i)); } return r; }
export default defineTests('fizz-buzz', (t) => {
