...
export default defineTests('rotate', (t) => {
  // ── Visible Tests ──
  ...
  t.hidden('long-right-wrap', { args: [[9, 8, 7, 6, 5, 4, 9, 8, 7, 6, 5, 4, 9, 8, 7, 6, 5, 4, 9, 8], 7, "right"], expected: [8, 7, 6, 5, 4, 9, 8, 9, 8, 7, 6, 5, 4, 9, 8, 7, 6, 5, 4, 9] });
