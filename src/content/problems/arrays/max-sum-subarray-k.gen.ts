...
export default defineTests('max-sum-subarray-k', (t) => {
  // ── Visible Tests ──
  t.visible('standard-mid', { args: [[2, 1, 5, 1, 3, 2], 3], expected: 9 });
  t.visible('ties', { args: [[2, 3, 4, 1, 5], 2], expected: 7 });
  ...
  // ── Hidden Tests ──
  t.hidden('large-array-small-k', { args: [[1, 5, 2, 8, 3, 7, 1, 5, 2, 8, 3, 7], 4], expected: 20 });
  t.hidden('all-negative-large', { args: [[-5, -1, -4, -2, -3, -5, -1, -4, -2, -3], 3], expected: -7 });
