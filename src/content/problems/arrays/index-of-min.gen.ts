...
export default defineTests('index-of-min', (t, rng) => {
  ...
  t.hidden('tied-minima-middle', { args: [[4, 2, -12, 7, -12, 4, -12]], expected: 2 });
  t.hidden('repeated-negative-min', { args: [[-1, -5, -8, -1, -5, -1, -8, -8]], expected: 2 });
  ...
  t.hidden('first-repeated', { args: [[5, 10, -11, -11, 9, 5, -11]], expected: 2 });
  t.hidden('large-minima-gaps', { args: [[3, 1, -14, 1, -14, 2, -14, 0, 3]], expected: 2 });
  t.hidden('descending-segments', { args: [[8, 7, 6, 5, 4, 3, 2, -1, 8, 7, 6]], expected: 7 });
  t.hidden('first-top-not-last', { args: [[8, 9, 10, 0, -10, 0, -8, 0, -10, -10, 0]], expected: 4 });
